...
export default function File({
  ...
  function getIcon(file: string) {
    ...
    if (fileName.includes("home"))
      return <img src="./assets/react_icon.svg" alt="" className="w-4 h-4" />;
    if (fileName.includes("projects"))
      return <img src="./assets/ts-icon.svg" alt="" className="w-5 h-5" />;
    if (fileName.includes("about"))
      return <img src="./assets/html_icon.svg" alt="" className="w-5 h-5" />;
    if (fileName.includes("contact"))
      return <img src="./assets/css_icon.svg" alt="" className="w-4 h-4" />;
  }
